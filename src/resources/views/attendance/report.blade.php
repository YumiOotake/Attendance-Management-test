...
@section('content')
    <div class="l-inner">
        <div class="attendance-report__list">
                ...
                <table class="attendance-report__monthly-table">
                    <thead class="attendance-report__thead">
                        <tr class="attendance-report__row">
                            <th class="attendance-report__header attendance-report__month">月</th>
                            <th class="attendance-report__header">労働時間</th>
                            <th class="attendance-report__header attendance-report__overtime">残業時間</th>
                        </tr>
                    </thead>
            ...
            <section class="attendance-report__group">
                ...
                <div class="attendance-report__summary">
                    <div class="attendance-report__card">
                        ...
                        <p class="attendance-report__result attendance-report__count">{{ $anomalies['late_count'] }}回
                        </p>
                    </div>
                    <div class="attendance-report__card">
